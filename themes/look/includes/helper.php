...
if(!function_exists('woo_check_breadcrumbs'))
{
    ...
    {
        global $_quick_view;
        if( !look_get_option('display_breadcrumbs') || $_quick_view) {
            return array();
        }
        return $crumbs;
    }
...
if(!function_exists('look_theme_header_script'))
{
    function look_theme_header_script() {
        ...
        <script type="text/javascript" >
            ...
            var look_cart_url = "'.apply_filters( 'woocommerce_add_to_cart_redirect', wc_get_cart_url() ).'";
            var look_redirect_cart = "'.get_option( 'woocommerce_cart_redirect_after_add' ).'";
