<?php
add_action( 'woocommerce_single_quick_view_product_summary', 'woocommerce_template_single_title', 5 );
add_action( 'woocommerce_single_quick_view_product_summary', 'woocommerce_template_single_rating', 10 );
add_action( 'woocommerce_single_quick_view_product_summary', 'woocommerce_template_single_price', 10 );
add_action( 'woocommerce_single_quick_view_product_summary', 'woocommerce_template_single_excerpt', 20 );
add_action( 'woocommerce_single_quick_view_product_summary', 'woocommerce_template_single_add_to_cart', 30 );
...
add_filter('body_class','look_wc_body_class',10,2);
function look_wc_body_class($classes, $class)
{
    global $_quick_view;
    $classes[] = VIEW.'-layout';
    if($_quick_view)
...
function look_woocommerce_shortcode_products_query($query_args, $atts, $loop_name = false)
{
    if($loop_name && $loop_name == 'featured_products')
    {
...
add_filter( 'woocommerce_shortcode_products_query', 'look_woocommerce_shortcode_products_query', 100, 3 );
