...
class Look_Assets
{
    ...
    public function  look_assets()
    {
        ...
        wp_enqueue_style('look_colorbox', MAIN_ASSETS_URI . '/css/colorbox.css');
        ...
        wp_enqueue_script('look_colorbox', MAIN_ASSETS_URI . '/js/jquery.colorbox-min.js',array('jquery'), VERSION, true);
