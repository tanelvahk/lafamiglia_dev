<body <?php body_class( 'home-left-layout' ); ?>>
	<div id="wrapper">
		<div id="sidebar">
			<a href="javascript:void(0);" class="mobile-button visible-sm visible-xs" id="close-btn"><?php _e('Menu','look')?></a>
			<header id="header">
		...
		<div class="header-top">
			<a href="javascript:void(0);" class="mobile-button visible-sm visible-xs" id="menu-toggle"><?php _e('Menu','look')?></a>
		</div>
		<div id="content">
