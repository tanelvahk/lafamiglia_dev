					...
					<div class="container-fluid">
						<div class="row">
							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								...
								<div class="logo"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img class="regular-logo" src="<?php echo (look_get_option('look_logo')=='')?  ASSETS_URI.'/images/logo.png': look_get_option('look_logo') ; ?>" alt="Logo"/><img class="retina-logo" src="<?php echo (look_get_option('look_retina_logo')=='')?  ASSETS_URI.'/images/logo2x.png': look_get_option('look_retina_logo') ; ?>" alt="Logo"/></a></div>
							</div>
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 top-menu">
								<?php if ( class_exists( 'WooCommerce' ) ) : ?>
									...
									?>
									<ul>
										<li class="menu-toggle visible-sm visible-xs icon"><a href="javascript:void(0);" title="<?php _e('Menu','look')?>" id="menu-toggle"><?php _e('Menu','look')?></a></li>
								...
								<?php else: ?>
									<ul>
										<li class="menu-toggle visible-sm visible-xs icon"><a href="javascript:void(0);" title="<?php _e('Menu','look')?>" id="menu-toggle1"><?php _e('Menu','look')?></a></li>
										<li class="mobile-search icon"><a href="javascript:void(0);" title="<?php _e('Search','look')?>" data-target="#searchModal" data-toggle="modal"><?php _e('Search','look')?></a></li>
									</ul>
								<?php endif; ?>
							</div>
						...
						<div class="row">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<nav class="main-menu">
									...
									<div class="logo col-lg-2 col-md-2 col-sm-12 col-xs-12"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img class="regular-logo" src="<?php echo (look_get_option('look_logo')=='')?  ASSETS_URI.'/images/logo.png': look_get_option('look_logo') ; ?>" alt="Logo"/><img class="retina-logo" src="<?php echo (look_get_option('look_retina_logo')=='')?  ASSETS_URI.'/images/logo2x.png': look_get_option('look_retina_logo') ; ?>" alt="Logo"/></a></div>
							...
							<div class="visible-sm visible-xs col-sm-12 col-xs-12 mobile-top-menu top-menu">
								<?php if ( class_exists( 'WooCommerce' ) ) : ?>
									...
									?>
									<ul>
										<li class="menu-toggle icon"><a href="javascript:void(0);" title="<?php _e('Menu','look')?>" id="menu-toggle"><?php _e('Menu','look')?></a></li>
										<?php if ( class_exists( 'WooCommerce' ) ) : ?>
											<?php if (is_user_logged_in()):?>
				...
				<div class="header-middle">
					<div class="container-fluid">
						<div class="row">
							<h1 class="visual-hidden"><?php wp_title(); ?></h1>
							<nav class="main-menu">
								<div class="logo col-lg-3 col-md-3 col-sm-12 col-xs-12"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img class="regular-logo" src="<?php echo (look_get_option('look_logo')=='')?  ASSETS_URI.'/images/logo.png': look_get_option('look_logo') ; ?>" alt="Logo"/><img class="retina-logo" src="<?php echo (look_get_option('look_retina_logo')=='')?  ASSETS_URI.'/images/logo2x.png': look_get_option('look_retina_logo') ; ?>" alt="Logo"/></a></div>
