<div id="content-promo">
	<div class="row">
        <?php if ( is_active_sidebar( 'blog-top-sidebar' ) ) : ?>
            <?php
            if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('blog-top-sidebar') ) :
            endif; ?>
        <?php endif; ?>
			...
			<div class="blog-section">
				<?php if ( have_posts() ) : ?>
					...
					<?php while ( have_posts() ) : the_post(); ?>
						<article class="<?php if(is_sticky()):?> sticky <?php endif; ?> look post hentry" <?php look_schema_metadata( array( 'context' => 'entry' ) ); ?>>
