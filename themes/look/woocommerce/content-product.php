...
<?php if(look_get_option('product_listing')== 2): ?>
	...
	<?php elseif(look_get_option('product_listing')== 5): ?>
		<div <?php post_class( 'grid-item col-lg-5 col-md-5 col-sm-6 col-xs-12' ); ?>>
	<?php elseif(look_get_option('product_listing')== 6): ?>
		<div <?php post_class( 'grid-item col-lg-2 col-md-2 col-sm-6 col-xs-12' ); ?>>
		<?php else: ?>
			<div <?php post_class( 'grid-item col-lg-3 col-md-3 col-sm-6 col-xs-12' ); ?>>
			<?php endif ?>

			<?php do_action( 'woocommerce_before_shop_loop_item' ); ?>
			<div class="item-wrap">
				<?php if(!isset($look_quickview) || $look_quickview != 'no'): ?>
					<a class="quick-view"  href="javascript:void(0);<?php // echo add_query_arg( '_quickview', '1', get_permalink() ); ?>"  product-data="<?php echo esc_attr($product->get_id()); ?>" ><?php _e('+ Quick View','look')?></a>
				<?php endif; ?>
